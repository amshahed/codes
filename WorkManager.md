# ব্যাকগ্রাউন্ড টাস্কের জন্য WorkManager
...
## এত কিছু থাকতে WorkManager-এর দরকার কি
...
- অন্যান্য লাইব্রেরির মত WorkManager সেট করার জন্য বেশি কোড লিখতে হয় না। শুধুমাত্র কাজের কোডটুকু লিখলেই হল।
- ডিভাইস রিস্টার্ট করলেও কাজ হারিয়ে যায় না।
...
- ডিভাইস ভার্শন নিয়ে চিন্তা করা লাগে না, ভার্শন অনুযায়ী নিজেই সঠিক প্রসেস নির্বাচন করে কাজ করে।
...
## কিছু রসকষহীন কিন্তু দরকারি থিওরি
...
এই বক্সকে চেক করলেই হল। উল্লেখ্য যে Android Studio-র ভার্শন **3.0** বা এর উপরে হতে হবে।
...
বেস! পুরো প্রজেক্টকে AndroidX লাইব্রেরির ভেতরে নিয়ে আসা হবে। মনে রাখতে হবে এই চমৎকার ফিচারটি পেতে হলে Android Studio-র ভার্শন **3.2** বা এর উপরে হতে হবে। না থাকলে একটু সময় নিয়ে আপডেট করে নাও।
...
জ্ঞান আহরণ এবং প্রজেক্ট সেট করার কাজ শেষ, অবশেষে আসল কোডিং শুরু করতে পারি আমরা। বিভিন্ন ক্ষেত্রে WorkManager দরকার হতে পারে। যেমন, ইন্টারনেট আসলে অনলাইন রেজিস্ট্রেশনের কাজ সম্পন্ন করা, ডিভাইসের চার্জ বা স্টোরেজ কম হয়ে গেলে ইউজারকে জানানো, অ্যাপ থেকে রিমাইন্ডার দেয়া ইত্যাদি। WorkManager কিভাবে কাজ করে তা বোঝার জন্য আমরা একটা সোজাসাপটা কাজ করব। অ্যাপ যখন নেটওয়ার্কে কানেক্ট করে তখন আমরা একটি নোটিফিকেশন পাঠাতে চাই।
...
WorkInfo-র মাধ্যমে আমরা কাজটির বিভিন্ন স্টেট জানতে পারি এবং সে অনুযায়ী UI আপডেট করতে পারি। এটি কিভাবে কাজ করে দেখানোর জন্য এই কাজটির WorkInfo-কে *observe* করে TextView-তে দেখাচ্ছি।
...
আজকে আমরা WorkManager দেখলাম। আশা করি, নিজেদের অ্যাপের প্রয়োজনে সহজেই একে ব্যবহার করতে পারবে। আশা করি সামনে এমন আরও গুরুত্বপূর্ণ বিষয় নিয়ে কথা বলব। সে পর্যন্ত, হ্যাপি কোডিং!
